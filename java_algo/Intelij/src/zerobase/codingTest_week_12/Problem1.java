    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 1; i <= 5; i++) {
            BufferedReader bf = new BufferedReader(
                    new FileReader("./src/zerobase.codingTest_week_12/test/problem1/acc_test/"+i+"_i.txt")
            );
            String x =bf.readLine().replaceAll("\"", "");
            bf = new BufferedReader(
                    new FileReader("./src/zerobase.codingTest_week_12/test/problem1/acc_test/"+i+"_o.txt")
            );
